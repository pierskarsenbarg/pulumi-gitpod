...
namespace PiersKarsenbarg.Gitpod
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pierskarsenbarg/pulumi-gitpod";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Gitpod.version.txt");
    ...
    internal sealed class GitpodResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GitpodResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
